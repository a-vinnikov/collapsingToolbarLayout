...
class CollapsingExtendToolbarLayout : FrameLayout {
    ...
    internal fun setScrimAlpha(alpha: Int) {
        if (alpha != scrimAlpha) {
            ...
            scrimAlpha = alpha
            ViewCompat.postInvalidateOnAnimation(this@CollapsingExtendToolbarLayout)
        }
    }
    ...
    private inner class OffsetUpdateListener :
        ...
        override fun onOffsetChanged(layout: AppBarLayout, verticalOffset: Int) {
            ...
            val expandRange = height - ViewCompat.getMinimumHeight(
                this@CollapsingExtendToolbarLayout
            ) - insetTop
